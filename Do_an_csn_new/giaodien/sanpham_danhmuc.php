    ...
    <div class="col-3">
        ...
        <div class="col-9">
            <div class="row pt-2 ">
              ...
              $sql = "SELECT sp.masanpham, ha.img, sp.tensanpham, sp.gia,  sp.iddm FROM sanpham sp, hinhanh ha WHERE sp.masanpham = ha.idsp AND ha.trangthai=1";
              ...
              if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                      echo '<div class="col-3 bg-white border-0 text-white product-item">
                          <div class="card text-dark text-center relative" style="width:14rem;">
                              <a href="#"><img src="../images/'.$row["img"].'" style="width: 13rem;" alt="..."></a>
                              <div class="card-body">
